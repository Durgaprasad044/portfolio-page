  ...
  const experiences = [
    {
      ...
      location: "Hyderabad",
      highlights: [
        "Managed placement operations for 1500+ students",
        "Coordinated with recruiters and departments to streamline communication",
        "Facilitated company visits and placement drives",
        "Maintained placement records and student progress tracking",
      ],
    },
    {
      title: "AI Engineer",
      ...
      location: "Remote",
      highlights: [
        "Developed AI-powered educational features and solutions",
        "Implemented machine learning models for personalized learning",
        "Collaborated with cross-functional teams on AI integration",
        "Optimized AI workflows for production deployment",
      ],
    },
  ]
