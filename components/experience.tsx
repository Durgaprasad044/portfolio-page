  ...
  const experiences = [
    {
      ...
      highlights: [
        ...
        "Streamlined communication and facilitation between companies and students",
        "Coordinated company visits and placement drives for student opportunities",
        "Maintained comprehensive placement records and tracked student progress",
      ],
    },
    {
